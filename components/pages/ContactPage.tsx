          ...
          <div className="section-inner contact-inner">
            ...
            {language === 'ko' && (
              <div className="kakao-cta-wrap">
                <p className="kakao-cta-label">{(t.contact as Record<string, string>).kakaoLabel}</p>
                <div className="kakao-cta-buttons">
                  ...
                  >
                    ...
                    {(t.contact as Record<string, string>).kakaoChat}
                  </a>
                  <a
                  ...
                  >
                    ...
                    {(t.contact as Record<string, string>).kakaoAdd}
                  </a>
                </div>
              </div>
            )}
